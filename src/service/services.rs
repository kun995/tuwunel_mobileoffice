...
pub struct Services {
	...
	pub deleted_events: Arc<rooms::deleted_events::Service>,
	...
	pub workspace: Arc<rooms::workspace::Service>,
...
pub async fn build(server: Arc<Server>) -> Result<Arc<Self>> {
	...
	let res = Arc::new(Self {
		...
		deleted_events: rooms::deleted_events::Service::build(&args)?,
		...
		workspace: rooms::workspace::Service::build(&args)?,
